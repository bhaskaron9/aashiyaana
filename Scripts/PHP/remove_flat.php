<?php
		...
		)
	{
			...
			)
		{
			...
			$query1="DELETE * FROM `flat_finder`.`flatdetails` WHERE ID=$idd;";
			$query2="DELETE * FROM `flat_finder`.`contactdetails` WHERE FlatCode=$idd;";
			$query4="DELETE * FROM `flat_finder`.`mapin` WHERE FlatCode=$idd;";
			$query5="DELETE * FROM `flat_finder`.`addressdetails` WHERE FlatCode=$idd;";
			$query6="DELETE * FROM `flat_finder`.`agreement` WHERE FlatCode=$idd;";
...
<head>
Removed!
<a href="sellerportal.php">Back to Home</a>
</head>
</html>
