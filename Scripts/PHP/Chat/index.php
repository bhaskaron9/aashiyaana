...
<html lang="EN">
	...
	<div class="holder">
		<label="welcomemsg">Chat with </label><label for="name"><?php echo $recipient; ?></label>
			<div class="style">	
				<div class="alpha">
					...
					<form name="newMessage" class="newMessage" action="" onsubmit="return false">
						<input type="text" id="recipient" name="recipient" style= "visibility:hidden;" value="<?php echo $recipient; ?>">
