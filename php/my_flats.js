...
function setmarkers()
{
	...
	for(var i=0;i<mnodes.length;i++)
	{
		...
		var html="<a href='#'>Go to link</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:remove()' title='Remove'><small><span id='dont_need' class='glyphicon glyphicon-trash'></span></small></a>&nbsp;&nbsp;<a href='javascript:editit("+my_lat+","+my_lng+")'><small><span class='glyphicon glyphicon-pencil'></span></small></a>";
